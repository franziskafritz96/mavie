...
<!--
 ...
 <div class="pageBtn" data-page="seite5" data-animate="ease" data-direction="left">
            <div class="marginleft_p_wirsind list_schwanger">
                    <p>
                        Nein
                    </p>
            ...
            <div class="marginmiddle list">
                    <p>
                        Ich weiß es nicht
                    </p>
            </div>
        
            <div class="marginright list">
